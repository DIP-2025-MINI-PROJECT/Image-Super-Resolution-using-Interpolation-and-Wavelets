...
### Contributors:
1. Kanishk K A (PES1UG23EC141)
2. Joel A Francis (PES1UG23EC134)

### Steps:
1. Clone Repository git clone https://github.com/DIP-2025-MINI-PROJECT/Image-Super-Resolution-using-Interpolation-and-Wavelets.git
...
3. Not as Powerful as Deep Learning Methods
   
### Future Work
1. Integrate Deep Learning Models
2. Implement Multi-Level Wavelet Decomposition
3. Introduce Noise Reduction or Regularization
